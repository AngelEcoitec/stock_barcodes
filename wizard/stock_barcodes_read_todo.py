...
class WizStockBarcodesReadTodo(models.TransientModel):
    ...
    def _compute_quantity(self):
        for rec in self:
            rec.quantity = sum(ln.quantity for ln in rec.line_ids)
