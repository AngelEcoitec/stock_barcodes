...
const originalOnKeyDown = NumericStep.prototype._onKeyDown;

patch(NumericStep.prototype, { name: "Adds barcode event handling and focus", 
    ...
    _onKeyDown(ev) {
        ...
        if (originalOnKeyDown) {
            originalOnKeyDown.apply(this, arguments);
        }
    },
});
